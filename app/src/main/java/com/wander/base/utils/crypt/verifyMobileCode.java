//by hujianhua 验证验证码
package com.wander.base.utils.crypt;			//指定类所在的包

import java.io.UnsupportedEncodingException;

public class verifyMobileCode
{
    ...
    /**
     * 徐赟修改了其实现，碰到了中文字符则先转换成utf8字节码再md5，且返回的是大写字母
     * @param s
     * @return
     */
    public String getMD5ofStr(String s)
    {
        return getMD5ofStr(s, "UTF-8").toUpperCase();
    }
    ...
    /**
     * 能够接受中文的 MD5 编码，由于历史问题，请慎重调用此函数，如果要调用，请向大家请教
     * 以前的一些算法使用的都是前面的那个函数
     * 
     * @param s
     * @param charSet
    ...
    {
        verifyMobileCode md5 = new verifyMobileCode();
